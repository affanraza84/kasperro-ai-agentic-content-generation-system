Here is the **final polished `README.md`**, formatted **exactly for copy–paste**, with clean Markdown styling and compliant structure.
No extra comments — ready to drop directly into your repository.
